...
int InA1 = 2;
int InB1 = 4;
int PWM2 = 3;  //PWM2 connects to pin 3
int PWM2_val = 45; //(25% = 64; 50% = 127; 75% = 191; 100% = 255) was 30

// Left motor
int InA2 = 7;
int InB2 = 8;
int PWM1 = 6;  //PWM1 connects to pin 6
int PWM1_val = 40; //(25% = 64; 50% = 127; 75% = 191; 100% = 255) was 63
